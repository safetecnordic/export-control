...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        Category.objects.get_or_create(identifier=5, name = "TELECOMMUNICATIONS AND INFORMATION SECURITY", part = 1)
        Category.objects.get_or_create(identifier=5, name = "TELECOMMUNICATIONS AND INFORMATION SECURITY", part = 2)
